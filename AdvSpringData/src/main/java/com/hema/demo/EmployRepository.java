...
public interface EmployRepository extends PagingAndSortingRepository<Employ, Integer>{
	...
	@Query("select e from Employ e where dept=?1 and desig=?2 and name like 'S%' order by basic desc")
	List<Employ> findSort(String dept,String desig,String basic,String name);
