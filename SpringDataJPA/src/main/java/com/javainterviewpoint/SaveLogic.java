    ...
    public void saveEmployee()
    {
        ...
        employee.setEmpName("Hema");
		 ...
		 employeeAddress1.setEmployee(employee);
		  ...
		  employeeAddress2.setCountry("Country 4");
		  employeeAddress2.setState("State 6"); employeeAddress2.setEmployee(employee);
