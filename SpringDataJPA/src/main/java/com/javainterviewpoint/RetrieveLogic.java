...
public class RetrieveLogic
{
    ...
    public void retrieveEmployee()
    {
        ...
        List<Employee> employeeList = employeeRepository.findByCity("State 1");
		...
		/*
		 * List<Employee> emplist=employeeRepository.findCountByState("Country 2"); for
		 * (Employee employee1 : emplist) { System.out.println(emplist); }
		 */  
        }
}
